...
* In **Treatment-Adjusted Risk** plot, for each data point, we also provide the variance **var** which is calculated as the difference in risk between query selected P1, P2 therapy and alternative therapy shown as you hover over. $var=(risk<sub>treat</sub> - risk<sub>query</sub>)/risk<sub>query</sub>$
